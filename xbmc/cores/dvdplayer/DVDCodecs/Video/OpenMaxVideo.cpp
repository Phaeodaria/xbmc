...
{
  //printf("OpenMaxVideoBufferHolder %p\n", this);
...
{
  printf("OpenMaxVideoBuffer %p %d\n", this, m_refs);
  m_openMaxVideo = 0;
}

OpenMaxVideoBuffer::~OpenMaxVideoBuffer()
{
  printf("~OpenMaxVideoBuffer %p\n", this);
  ReleaseTexture();
  if (m_openMaxVideo) {
